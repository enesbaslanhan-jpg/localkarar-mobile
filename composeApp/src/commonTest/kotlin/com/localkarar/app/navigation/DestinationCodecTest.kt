...
class DestinationCodecTest {
    ...
    fun testAllDestinationsRoundTrip() {
        val testCases: List<Destination> = listOf(
            ...
            Destination.DecisionTool(code = "finansman-karari"),
            ...
            Destination.EmployeeCreate(workspaceId = "ws_alpha"),
            Destination.EmployeeLeave(workspaceId = "ws_alpha", employeeId = "emp_1"),
            Destination.WorkspaceSettings(workspaceId = "ws_alpha"),
            Destination.Community("feed"),
            Destination.Community("people"),
            Destination.Community("threads"),
