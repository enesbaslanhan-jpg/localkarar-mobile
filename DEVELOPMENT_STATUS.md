...
The `feature/m1-mobile-shell-v2` branch establishes the **Native Primary Navigation (V1)** locked architecture for LocalKarar Compose Multiplatform.

## Current Status of Feature Integration

| Feature / Phase | Status | Notes |
| :--- | :--- | :--- |
| **M0 - Safety Baseline** | COMPLETE | Working tree clean, baseline build passed, dedicated M1 feature branch created |
...
| **Hesaplamalar Unified Catalog** | **FUNCTIONALLY_IMPLEMENTED** | Unified catalog, 34 items, 7 categories, formula quick & detailed model flows, Finansal Görünüm, History |
